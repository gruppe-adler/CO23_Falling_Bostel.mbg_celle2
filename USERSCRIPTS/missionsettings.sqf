//ÜBER DIE MISSION =============================================================
author = "Slant";                                               //Missionsersteller (Du)
onLoadName = "Falling Bostel";                                                   //Name der Mission
onLoadMission = "Die Russen sind bis nach Niedersachen vorgedrungen. In der Lüneburger Heide beginnt der Widerstand...";          //Beschreibung der Mission (wird im Ladebildschirm unterhalb des Ladebildes angezeigt)
loadScreen = "data\falling.jpg";                                                //Ladebild
